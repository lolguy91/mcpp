...
//
   ...
   // }
    ...
    int hashCode() {
        int n = m00 != 0.0f ? Float.floatToIntBits(m00) : 0;
        n = 31 * n + (m01 != 0.0f ? Float.floatToIntBits(m01) : 0);
        n = 31 * n + (m02 != 0.0f ? Float.floatToIntBits(m02) : 0);
        n = 31 * n + (m10 != 0.0f ? Float.floatToIntBits(m10) : 0);
        n = 31 * n + (m11 != 0.0f ? Float.floatToIntBits(m11) : 0);
        n = 31 * n + (m12 != 0.0f ? Float.floatToIntBits(m12) : 0);
        n = 31 * n + (m20 != 0.0f ? Float.floatToIntBits(m20) : 0);
        n = 31 * n + (m21 != 0.0f ? Float.floatToIntBits(m21) : 0);
        n = 31 * n + (m22 != 0.0f ? Float.floatToIntBits(m22) : 0);
        return n;
    }
    ...
    void store(FloatBuffer floatBuffer, boolean bl) {
        if (bl) {
